...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_shops_shops_component__ = __webpack_require__("./src/app/components/shops/shops.component.ts");
...
var appRoutes = [
    ...
    { path: 'shops', component: __WEBPACK_IMPORTED_MODULE_17__components_shops_shops_component__["a" /* ShopsComponent */] }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_17__components_shops_shops_component__["a" /* ShopsComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_14__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_16__angular_common_http__["a" /* HttpClientModule */], __WEBPACK_IMPORTED_MODULE_6__guards_auth_guard__["a" /* AuthGuard */]],
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateEmail(user.email)) {
            this.flashMessage.show('Please use a valid email address.', { cssClass: 'alert-danger', timeout: 5000 });
            return false;
        }
        //Register User
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('You are now registered.  Please log in.', { cssClass: 'alert-success', timeout: 5000 });
                _this.router.navigate(['/login']);
            }
            else {
...
var ShopsComponent = /** @class */ (function () {
    ...
    ShopsComponent.prototype.selectedLocation = function (event) {
